...
var (
	...
	fixtureTrashObjectNotFoundResponseError = &ResponseError{
...
func TestTrashObjectsClient_List(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.List(
...
func TestTrashObjectsClient_Get(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.Get(
...
func TestTrashObjectsClient_GetByID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.GetByID(tt.args.ctx, tt.args.id)
...
func TestTrashObjectsClient_GetByObjectID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.GetByObjectID(
...
func TestTrashObjectsClient_Purge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.Purge(tt.args.ctx, tt.args.trsh)
...
func TestTrashObjectsClient_PurgeAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.PurgeAll(tt.args.ctx, tt.args.org)
...
func TestTrashObjectsClient_Restore(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.TrashObjects.Restore(tt.args.ctx, tt.args.trsh)
