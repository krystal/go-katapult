...
var (
	...
	fixtureIPAddressNotFoundResponseError = &ResponseError{
...
func TestIPAddressesClient_List(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.IPAddresses.List(
...
func TestIPAddressesClient_Get(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.IPAddresses.Get(
...
func TestIPAddressesClient_GetByID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.IPAddresses.GetByID(tt.args.ctx, tt.args.id)
...
func TestIPAddressesClient_GetByAddress(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.IPAddresses.GetByAddress(
...
func TestIPAddressesClient_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.IPAddresses.Create(
...
func TestIPAddressesClient_Update(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, resp, err := c.IPAddresses.Update(
...
func TestIPAddressesClient_Delete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			resp, err := c.IPAddresses.Delete(tt.args.ctx, tt.args.ip)
...
func TestIPAddressesClient_Unallocate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			resp, err := c.IPAddresses.Unallocate(tt.args.ctx, tt.args.ip)
