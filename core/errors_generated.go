...
var (
	ErrCertificateNotFound = fmt.Errorf(
		"%w: certificate_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrCountryNotFound = fmt.Errorf(
		"%w: country_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrCountryStateNotFound = fmt.Errorf(
		"%w: country_state_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrCurrencyNotFound = fmt.Errorf(
		"%w: currency_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDNSRecordNotFound = fmt.Errorf(
		"%w: dns_record_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDNSZoneAlreadyVerified = fmt.Errorf(
		"%w: dns_zone_already_verified",
		katapult.ErrUnprocessableEntity,
	)
	ErrDNSZoneNotFound = fmt.Errorf(
		"%w: dns_zone_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDNSZoneNotVerified = fmt.Errorf(
		"%w: dns_zone_not_verified",
		katapult.ErrUnprocessableEntity,
	)
	ErrDataCenterNotFound = fmt.Errorf(
		"%w: data_center_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDeletionRestricted = fmt.Errorf(
		"%w: deletion_restricted",
		katapult.ErrConflict,
	)
	ErrDiskBackupPolicyNotFound = fmt.Errorf(
		"%w: disk_backup_policy_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDiskNotFound = fmt.Errorf(
		"%w: disk_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDiskTemplateNotFound = fmt.Errorf(
		"%w: disk_template_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrDiskTemplateVersionNotFound = fmt.Errorf(
		"%w: disk_template_version_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrFlexibleResourcesUnavailableToOrganization = fmt.Errorf(
		"%w: flexible_resources_unavailable_to_organization",
		katapult.ErrForbidden,
	)
	ErrIPAddressNotFound = fmt.Errorf(
		"%w: ip_address_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrIPAlreadyAllocated = fmt.Errorf(
		"%w: ip_already_allocated",
		katapult.ErrUnprocessableEntity,
	)
	ErrIdentityNotLinkedToWebSession = fmt.Errorf(
		"%w: identity_not_linked_to_web_session",
		katapult.ErrBadRequest,
	)
	ErrInfrastructureDNSZoneCannotBeEdited = fmt.Errorf(
		"%w: infrastructure_dns_zone_cannot_be_edited",
		katapult.ErrForbidden,
	)
	ErrInterfaceNotFound = fmt.Errorf(
		"%w: interface_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrInvalidIP = fmt.Errorf(
		"%w: invalid_ip",
		katapult.ErrUnprocessableEntity,
	)
	ErrInvalidSpecXML = fmt.Errorf(
		"%w: invalid_spec_xml",
		katapult.ErrBadRequest,
	)
	ErrLoadBalancerNotFound = fmt.Errorf(
		"%w: load_balancer_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrLoadBalancerRuleNotFound = fmt.Errorf(
		"%w: load_balancer_rule_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrLocationRequired = fmt.Errorf(
		"%w: location_required",
		katapult.ErrUnprocessableEntity,
	)
	ErrNetworkNotFound = fmt.Errorf(
		"%w: network_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrNetworkSpeedProfileNotFound = fmt.Errorf(
		"%w: network_speed_profile_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrNoAllocation = fmt.Errorf(
		"%w: no_allocation",
		katapult.ErrUnprocessableEntity,
	)
	ErrNoAvailableAddresses = fmt.Errorf(
		"%w: no_available_addresses",
		katapult.ErrServiceUnavailable,
	)
	ErrNoInterfaceAvailable = fmt.Errorf(
		"%w: no_interface_available",
		katapult.ErrUnprocessableEntity,
	)
	ErrNoUserAssociatedWithIdentity = fmt.Errorf(
		"%w: no_user_associated_with_identity",
		katapult.ErrResourceNotFound,
	)
	ErrObjectInTrash = fmt.Errorf(
		"%w: object_in_trash",
		katapult.ErrNotAcceptable,
	)
	ErrOperatingSystemNotFound = fmt.Errorf(
		"%w: operating_system_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrOrganizationLimitReached = fmt.Errorf(
		"%w: organization_limit_reached",
		katapult.ErrUnprocessableEntity,
	)
	ErrOrganizationNotActivated = fmt.Errorf(
		"%w: organization_not_activated",
		katapult.ErrForbidden,
	)
	ErrOrganizationNotFound = fmt.Errorf(
		"%w: organization_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrOrganizationSuspended = fmt.Errorf(
		"%w: organization_suspended",
		katapult.ErrForbidden,
	)
	ErrPermissionDenied = fmt.Errorf(
		"%w: permission_denied",
		katapult.ErrForbidden,
	)
	ErrRateLimitReached = fmt.Errorf(
		"%w: rate_limit_reached",
		katapult.ErrTooManyRequests,
	)
	ErrResourceCreationRestricted = fmt.Errorf(
		"%w: resource_creation_restricted",
		katapult.ErrForbidden,
	)
	ErrResourceDoesNotSupportUnallocation = fmt.Errorf(
		"%w: resource_does_not_support_unallocation",
		katapult.ErrConflict,
	)
	ErrSSHKeyNotFound = fmt.Errorf(
		"%w: ssh_key_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrSecurityGroupNotFound = fmt.Errorf(
		"%w: security_group_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrSecurityGroupRuleNotFound = fmt.Errorf(
		"%w: security_group_rule_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrSpeedProfileAlreadyAssigned = fmt.Errorf(
		"%w: speed_profile_already_assigned",
		katapult.ErrUnprocessableEntity,
	)
	ErrTagNotFound = fmt.Errorf(
		"%w: tag_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrTaskNotFound = fmt.Errorf(
		"%w: task_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrTaskQueueingError = fmt.Errorf(
		"%w: task_queueing_error",
		katapult.ErrNotAcceptable,
	)
	ErrTrashObjectNotFound = fmt.Errorf(
		"%w: trash_object_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrValidationError = fmt.Errorf(
		"%w: validation_error",
		katapult.ErrUnprocessableEntity,
	)
	ErrVirtualMachineBuildNotFound = fmt.Errorf(
		"%w: build_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrVirtualMachineGroupNotFound = fmt.Errorf(
		"%w: virtual_machine_group_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrVirtualMachineMustBeStarted = fmt.Errorf(
		"%w: virtual_machine_must_be_started",
		katapult.ErrNotAcceptable,
	)
	ErrVirtualMachineNetworkInterfaceNotFound = fmt.Errorf(
		"%w: virtual_machine_network_interface_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrVirtualMachineNotFound = fmt.Errorf(
		"%w: virtual_machine_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrVirtualMachinePackageNotFound = fmt.Errorf(
		"%w: package_not_found",
		katapult.ErrResourceNotFound,
	)
	ErrZoneNotFound = fmt.Errorf(
		"%w: zone_not_found",
		katapult.ErrResourceNotFound,
	)
)
...
func NewCertificateNotFoundError(
	theError *katapult.ResponseError,
) *CertificateNotFoundError {
...
func NewCountryStateNotFoundError(
	theError *katapult.ResponseError,
) *CountryStateNotFoundError {
...
func NewDNSRecordNotFoundError(
	theError *katapult.ResponseError,
) *DNSRecordNotFoundError {
...
func NewDNSZoneAlreadyVerifiedError(
	theError *katapult.ResponseError,
) *DNSZoneAlreadyVerifiedError {
...
func NewDNSZoneNotVerifiedError(
	theError *katapult.ResponseError,
) *DNSZoneNotVerifiedError {
...
func NewDataCenterNotFoundError(
	theError *katapult.ResponseError,
) *DataCenterNotFoundError {
...
func NewDeletionRestrictedError(
	theError *katapult.ResponseError,
) *DeletionRestrictedError {
...
func NewDiskBackupPolicyNotFoundError(
	theError *katapult.ResponseError,
) *DiskBackupPolicyNotFoundError {
...
func NewDiskTemplateNotFoundError(
	theError *katapult.ResponseError,
) *DiskTemplateNotFoundError {
...
func NewDiskTemplateVersionNotFoundError(
	theError *katapult.ResponseError,
) *DiskTemplateVersionNotFoundError {
...
func NewFlexibleResourcesUnavailableToOrganizationError(
	theError *katapult.ResponseError,
) *FlexibleResourcesUnavailableToOrganizationError {
...
func NewIPAddressNotFoundError(
	theError *katapult.ResponseError,
) *IPAddressNotFoundError {
...
func NewIPAlreadyAllocatedError(
	theError *katapult.ResponseError,
) *IPAlreadyAllocatedError {
...
func NewIdentityNotLinkedToWebSessionError(
	theError *katapult.ResponseError,
) *IdentityNotLinkedToWebSessionError {
...
func NewInfrastructureDNSZoneCannotBeEditedError(
	theError *katapult.ResponseError,
) *InfrastructureDNSZoneCannotBeEditedError {
...
func NewLoadBalancerNotFoundError(
	theError *katapult.ResponseError,
) *LoadBalancerNotFoundError {
...
func NewLoadBalancerRuleNotFoundError(
	theError *katapult.ResponseError,
) *LoadBalancerRuleNotFoundError {
...
func NewNetworkSpeedProfileNotFoundError(
	theError *katapult.ResponseError,
) *NetworkSpeedProfileNotFoundError {
...
func NewNoAvailableAddressesError(
	theError *katapult.ResponseError,
) *NoAvailableAddressesError {
...
func NewNoInterfaceAvailableError(
	theError *katapult.ResponseError,
) *NoInterfaceAvailableError {
...
func NewNoUserAssociatedWithIdentityError(
	theError *katapult.ResponseError,
) *NoUserAssociatedWithIdentityError {
...
func NewOperatingSystemNotFoundError(
	theError *katapult.ResponseError,
) *OperatingSystemNotFoundError {
...
func NewOrganizationLimitReachedError(
	theError *katapult.ResponseError,
) *OrganizationLimitReachedError {
...
func NewOrganizationNotActivatedError(
	theError *katapult.ResponseError,
) *OrganizationNotActivatedError {
...
func NewOrganizationSuspendedError(
	theError *katapult.ResponseError,
) *OrganizationSuspendedError {
...
func NewResourceCreationRestrictedError(
	theError *katapult.ResponseError,
) *ResourceCreationRestrictedError {
...
func NewResourceDoesNotSupportUnallocationError(
	theError *katapult.ResponseError,
) *ResourceDoesNotSupportUnallocationError {
...
func NewSpeedProfileAlreadyAssignedError(
	theError *katapult.ResponseError,
) *SpeedProfileAlreadyAssignedError {
...
func NewTrashObjectNotFoundError(
	theError *katapult.ResponseError,
) *TrashObjectNotFoundError {
...
func NewVirtualMachineBuildNotFoundError(
	theError *katapult.ResponseError,
) *VirtualMachineBuildNotFoundError {
...
func NewVirtualMachineGroupNotFoundError(
	theError *katapult.ResponseError,
) *VirtualMachineGroupNotFoundError {
...
func NewVirtualMachineMustBeStartedError(
	theError *katapult.ResponseError,
) *VirtualMachineMustBeStartedError {
...
func NewVirtualMachineNetworkInterfaceNotFoundError(
	theError *katapult.ResponseError,
) *VirtualMachineNetworkInterfaceNotFoundError {
...
func NewVirtualMachineNotFoundError(
	theError *katapult.ResponseError,
) *VirtualMachineNotFoundError {
...
func NewVirtualMachinePackageNotFoundError(
	theError *katapult.ResponseError,
) *VirtualMachinePackageNotFoundError {
