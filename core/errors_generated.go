...
// AddressListEntryNotFoundError:
// No address list entry was found matching any of the criteria provided in the arguments.
...
func NewAddressListEntryNotFoundError(theError *katapult.ResponseError) *AddressListEntryNotFoundError {
	return &AddressListEntryNotFoundError{
		CommonError: katapult.NewCommonError(
			ErrAddressListEntryNotFound,
...
// AddressListNotFoundError:
// No address list was found matching any of the criteria provided in the arguments.
...
func NewAddressListNotFoundError(theError *katapult.ResponseError) *AddressListNotFoundError {
	return &AddressListNotFoundError{
		CommonError: katapult.NewCommonError(
			ErrAddressListNotFound,
...
func castResponseError(theError *katapult.ResponseError) error {
	...
	case "address_list_entry_not_found":
		return NewAddressListEntryNotFoundError(theError)
	case "address_list_not_found":
		return NewAddressListNotFoundError(theError)
